...
import registerPatient as regV
import admFunc as adFunc
from tkinter import *
from registerPatient import *
from admFunc import *
...
def AdminHome(root,frame1,frame3):
    ...
    #Voter Login
    registerVoter = Button(frame1, text="Register Patient", width=15, command = lambda: regV.Register(root, frame1))

    #Show Votes
    showVotes = Button(frame1, text="Show Beds", width=15, command = lambda: adFunc.showVotes(root, frame1))
